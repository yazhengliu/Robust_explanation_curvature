...
class DeepLIFT_link(WalkBase):
    ...
    def forward(self,
        ...
        self.model.eval()
        print('self.numnodes',self.num_nodes)
        ...
        edge_weight_with_ref=torch.cat([kwargs.get('edge_weight'),kwargs.get('edge_weight')])
        
        # print('len edge_weight_with_ref',len(edge_weight_with_ref),edge_weight_with_ref)
        # 
        # 
        # print('inp_with_ref',len(inp_with_ref),inp_with_ref)
        # print('edge_index_with_ref',len(edge_index_with_ref[0]),edge_index_with_ref)
        # 
        # print(len(kwargs.get('edge_weight')))

        out = self.model(inp_with_ref, edge_index_with_ref,edge_weight_with_ref,kwargs.get('pos_edge_index'))
