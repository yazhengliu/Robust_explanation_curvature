...
# from benchmark.models.utils import
...
class FlowX_plus(FlowBase):
    ...
    def __init__(self, model, epochs=500, lr=0.01, explain_graph=False, molecule=False):
    ...
    def forward(self,
        ...
        return walks, edge_attr, related_preds

    def __loss__(self, raw_preds, x_label,sparsity):
    ...
    def train_mask(self,
        ...
        for epoch in range(1, self.epochs + 1):
            ...
            loss = self.__loss__(raw_preds, ex_label,kwargs.get('sparsity'))
