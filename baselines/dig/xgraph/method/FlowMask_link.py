...
from .base_explainer_link import FlowBase
...
class FlowMask_link(FlowBase):
    ...
    def train_mask(self,
        ...
        for epoch in range(1, self.epochs + 1):
            ...
            with self.temp_mask(self, temp_edge_mask):
                # print('test edge index',kwargs.get('pos_edge_index'),)
                # 
                raw_preds = self.model(x, edge_index, edge_weight,pos_edge_index)
    ...
    def forward(self,
        ...
        self.ori_logits_pred = self.model(x, edge_index,kwargs.get('edge_weight'),kwargs.get('pos_edge_index')).softmax(1)
        ...
        #print('load walk_plain_indices_list')
        ...
        #print('load flow2layeredge_matrix')
        

        labels = [kwargs.get('given_class')]#tuple(i for i in range(kwargs.get('num_classes')))
        ...
        for ex_label in ex_labels:
            ...
            self.train_mask(x, edge_index, ex_label=ex_label,edge_weight=kwargs.get('edge_weight'),pos_edge_index=kwargs.get('pos_edge_index'))
