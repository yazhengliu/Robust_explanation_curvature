import utils.EffRApprox as er
import utils.Spielman_Sparse as spl
import utils.RanGraphGen as rg
import utils.FastSims as fs
import numpy as np
...
class Network:
    ...
    def effR(self, epsilon, method, tol=1e-10, precon=False):
        #print('E_list',self.E_list)
        return self.E_list,er.EffR(self.E_list, self.weights, epsilon, method, tol=tol, precon=precon)
